...
class TestMMS_Temporal < Test::Unit::TestCase
  ...
  def test_1_run
    ...
    assert((steps - 700).abs < 10, "Failed to take correct number of steps.")
  end
  ...
  def test_2_check_norms
    ...
    lines = o.split("\n")
    names = ['L1', 'L2', 'Linf']
    refs = {'L1'=>6.071675738758957989e-03, 'L2'=>7.045093394398087641e-03, 'Linf'=>1.202567037544766126e-02}
